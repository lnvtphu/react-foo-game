...
import { emailFormat } from '../utils/customFormatTV4';

// import schema
import { registerSchema } from '../utils/schemaValidate';

import * as tv4 from 'tv4';

const register = (req, res) => {
    tv4.addFormat({email: emailFormat});
    const result = tv4.validateMultiple(req.body, registerSchema);
    // console.log(result);
